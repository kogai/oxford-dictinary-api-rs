...
pub trait UtilityApi {
    fn domains_source_domains_language_target_domains_language_get(
        &self,
        source_domains_language: &str,
        target_domains_language: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::UtilityLabels, Error = Error<serde_json::Value>>>;
    fn domains_source_language_get(
        &self,
        source_language: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::UtilityLabels, Error = Error<serde_json::Value>>>;
    fn filters_endpoint_get(
        &self,
        endpoint: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::Filters, Error = Error<serde_json::Value>>>;
    fn filters_get(
        &self,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::Filters, Error = Error<serde_json::Value>>>;
    fn grammatical_features_source_language_get(
        &self,
        source_language: &str,
        app_id: &str,
        app_key: &str,
    ...
    fn languages_get(
        ...
        source_language: &str,
        target_language: &str,
    ) -> Box<Future<Item = ::models::Languages, Error = Error<serde_json::Value>>>;
    fn lexicalcategories_language_get(
        &self,
        language: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::UtilityLabels, Error = Error<serde_json::Value>>>;
    fn regions_source_language_get(
        &self,
        source_language: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::Regions, Error = Error<serde_json::Value>>>;
    fn registers_source_language_get(
        &self,
        source_language: &str,
        app_id: &str,
        app_key: &str,
    ) -> Box<Future<Item = ::models::UtilityLabels, Error = Error<serde_json::Value>>>;
    fn registers_source_register_language_target_register_language_get(
        &self,
