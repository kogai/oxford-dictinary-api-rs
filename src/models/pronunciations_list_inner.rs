...
impl PronunciationsListInner {
  ...
  pub fn set_dialects(&mut self, dialects: Vec<String>) {
    self.dialects = Some(dialects);
  }

  pub fn with_dialects(mut self, dialects: Vec<String>) -> PronunciationsListInner {
    self.dialects = Some(dialects);
    self
  }

  pub fn dialects(&self) -> Option<&Vec<String>> {
  ...
  pub fn with_regions(mut self, regions: Vec<String>) -> PronunciationsListInner {
    self.regions = Some(regions);
    self
  }
