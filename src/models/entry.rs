...
impl Entry {
  ...
  pub fn set_etymologies(&mut self, etymologies: Vec<String>) {
    self.etymologies = Some(etymologies);
  }

  pub fn with_etymologies(mut self, etymologies: Vec<String>) -> Entry {
    self.etymologies = Some(etymologies);
    self
  }

  pub fn etymologies(&self) -> Option<&Vec<String>> {
  ...
  pub fn with_notes(mut self, notes: Vec<::models::CategorizedTextListInner>) -> Entry {
    self.notes = Some(notes);
    self
  }
  ...
  pub fn with_variant_forms(mut self, variant_forms: Vec<::models::VariantFormsListInner>) -> Entry {
    self.variant_forms = Some(variant_forms);
    self
  }
