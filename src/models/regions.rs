...
pub struct Regions {
  ...
  results: Option<::std::collections::HashMap<String, Vec<String>>>,
}
...
impl Regions {
  ...
  pub fn set_results(&mut self, results: ::std::collections::HashMap<String, Vec<String>>) {
  ...
  pub fn results(&self) -> Option<&::std::collections::HashMap<String, Vec<String>>> {
    self.results.as_ref()
  }
