...
impl TranslationsListInner {
  ...
  pub fn with_domains(mut self, domains: ::models::Arrayofstrings) -> TranslationsListInner {
    self.domains = Some(domains);
    self
  }
  ...
  pub fn with_grammatical_features(mut self, grammatical_features: ::models::GrammaticalFeaturesList) -> TranslationsListInner {
    self.grammatical_features = Some(grammatical_features);
    self
  }
  ...
  pub fn with_regions(mut self, regions: ::models::Arrayofstrings) -> TranslationsListInner {
    self.regions = Some(regions);
    self
  }
  ...
  pub fn with_registers(mut self, registers: ::models::Arrayofstrings) -> TranslationsListInner {
    self.registers = Some(registers);
    self
  }
