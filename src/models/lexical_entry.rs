...
pub struct LexicalEntry {
  ...
  derivatives: Option<::models::ArrayOfRelatedEntries>,
...
impl LexicalEntry {
  ...
  pub fn with_derivative_of(mut self, derivative_of: ::models::ArrayOfRelatedEntries) -> LexicalEntry {
    self.derivative_of = Some(derivative_of);
    self
  }
  ...
  pub fn set_derivatives(&mut self, derivatives: ::models::ArrayOfRelatedEntries) {
    self.derivatives = Some(derivatives);
  }

  pub fn with_derivatives(mut self, derivatives: ::models::ArrayOfRelatedEntries) -> LexicalEntry {
    self.derivatives = Some(derivatives);
    self
  }

  pub fn derivatives(&self) -> Option<&::models::ArrayOfRelatedEntries> {
  ...
  pub fn with_grammatical_features(mut self, grammatical_features: ::models::GrammaticalFeaturesList) -> LexicalEntry {
    self.grammatical_features = Some(grammatical_features);
    self
  }
  ...
  pub fn with_pronunciations(mut self, pronunciations: ::models::PronunciationsList) -> LexicalEntry {
    self.pronunciations = Some(pronunciations);
    self
  }
