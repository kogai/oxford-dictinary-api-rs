...
impl SynonymsAntonymsInner {
  ...
  pub fn with_domains(mut self, domains: ::models::Arrayofstrings) -> SynonymsAntonymsInner {
    self.domains = Some(domains);
    self
  }
  ...
  pub fn with_regions(mut self, regions: ::models::Arrayofstrings) -> SynonymsAntonymsInner {
    self.regions = Some(regions);
    self
  }
  ...
  pub fn with_registers(mut self, registers: ::models::Arrayofstrings) -> SynonymsAntonymsInner {
    self.registers = Some(registers);
    self
  }
